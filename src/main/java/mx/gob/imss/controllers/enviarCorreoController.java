...
public class enviarCorreoController {
    ...
    @PostMapping("envio")
    public void enviarCorreo(@RequestBody EnvioCorreosRequest request) throws MessagingException {
        enviar.enviarCorreo(request);
    }

    @PostMapping("envioArchivo")
    public void enviarCorreoConArchivo(@RequestBody EnvioCorreosRequest request) throws MessagingException {
